...
export function TableSequenceAddDialog({ coordinator, projectId, photoIds, summaries, initialSequenceId, onClose, onSummariesChange, onNotice }: TableSequenceAddDialogProps) {
