...
export function TableHeader({ dependencies, projectId, lastSequenceId, navigate }: {
  ...
  return <AppHeader dependencies={dependencies} route={{ name: "table", projectId }} projectId={projectId} lastSequenceId={lastSequenceId} navigate={navigate} variant="table" showProjectSettings={false} projectLabel={workspace?.name ?? t("common.loading")} actions={
